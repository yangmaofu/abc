...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    <div class="layui-logo"><img width="50" src="${ctx}/images/luanIcon.png"><b >潞安焦化质检系统</b></H3></div>
    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree layui-bg-blue"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a href="javascript:;" data-id="1" data-title="列表一" data-url="table.html" data-type="tabadd">列表一</a></dd>
            <dd><a href="javascript:;"  data-id="2" data-title="列表二" data-url="table.html" data-type="tabadd">列表二</a></dd>
            <dd><a href="javascript:;"  data-id="3" data-title="列表三" data-url="table.html" data-type="tabadd">列表三</a></dd>
            <dd><a href="">超链接</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
